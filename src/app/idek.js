...
import { ChevronRight, Folder, Code, Gamepad, Cpu, Users, Rocket, Lightbulb, ChevronDown, FolderOpen } from 'lucide-react';
  ...
  const faqs = [
    {
      ...
      answer: 'Absolutely not! Our club is open to all skill levels. We provide resources and support to help everyone learn and grow, regardless of your background.'
    },
    {
      question: 'What kind of projects do you work on?',
      answer: 'We work on a wide variety of projects, including websites, games, mobile apps, and more. You\'re encouraged to bring your own ideas and build something you\'re passionate about!'
    },
    {
      question: 'How often do you meet?',
      answer: 'We meet weekly after school. Check our social media or contact us for the exact day and time.'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[var(--color-primary-dark)] text-[var(--color-primary-light)] flex flex-col relative">
      ...
      <main className="flex-grow">
        <section className="relative min-h-screen flex overflow-hidden pt-32 pb-16">
          ...
          >
            <div className="p-4 md:p-16">
              ...
              >
                Our Hack Club VMSS is a community of hackers and builders. We meet weekly to learn new skills, build projects, and have fun.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        <section id="about" className="py-20 md:py-32 bg-[var(--color-secondary-dark)] text-[var(--color-primary-light)]">
          <div className="max-w-8xl mx-auto px-8 md:px-16">
            <div className="grid grid-cols-1 2xl:grid-cols-2 gap-16 items-center">
              <div className="text-center 2xl:text-left 2xl:order-2">
                ...
                >
                  We are the local Hack Club VMSS chapter at Vincent Massey Secondary School. We're a part of the global Hack Club community, a worldwide nonprofit that supports high schoolers learning to code by connecting them with a global network of peers and resources. We provide a space for you to explore technology, build amazing things, and make new friends along the way.
                </motion.p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mt-12">
                  ...
                  >
                    <Users size={64} className="text-[var(--color-accent-blue)] mb-6" />
                    <h3 className="text-2xl font-bold mb-4 text-[var(--color-primary-light)]">Community</h3>
                    <p className="text-gray-400 text-base">Join a community of like-minded students who love to build and create.</p>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, scale: 0.9 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-[var(--color-primary-light)]">Projects</h3>
                    <p className="text-gray-400 text-base">Work on fun and impactful projects, from websites to games and mobile apps.</p>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, scale: 0.9 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-[var(--color-primary-light)]">Learn</h3>
                    <p className="text-gray-400 text-base">Gain hands-on experience and learn from experienced mentors and peers.</p>
                  </motion.div>
                </div>
              </div>
        ...
        <section id="what-you'll-learn" className="py-20 md:py-32 bg-[var(--color-primary-dark)] text-[var(--color-primary-light)]">
          <div className="container mx-auto px-8 md:px-16 text-center">
            ...
            >
              We'll dive into a variety of topics, all designed to give you the skills you need to build anything you can imagine.
            </motion.p>
            ...
            <div className="max-w-6xl mx-auto bg-[var(--color-secondary-dark)] rounded-3xl shadow-2xl overflow-hidden border border-gray-700">
              <div className="flex p-4 border-b border-gray-700 overflow-x-auto">
                <div className="flex flex-shrink-0 space-x-2">
                  <div className="w-3 h-3 rounded-full bg-red-500"></div>
                  <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
                  <div className="w-3 h-3 rounded-full bg-green-500"></div>
                </div>
                <div className="flex flex-grow items-center space-x-4 ml-8 md:ml-0">
                  {learnSections.map((section, index) => {
                    ...
                    return (
                      <button
                        key={index}
                        className={`flex flex-shrink-0 items-center justify-center p-3 rounded-xl transition-all duration-300 min-w-[150px] ${isSelected ? 'bg-[var(--color-accent-blue)] text-white transform scale-105' : 'text-gray-400 hover:text-white hover:bg-gray-700'}`}
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <ul className="space-y-4">
                    {learnSections[selectedLearnSection].bullets.map((bullet, index) => (
                      <li key={index} className="flex items-start text-gray-400 text-base">
                        <ChevronRight size={24} className="text-blue-500 mr-3 mt-1" />
                        <span>{bullet}</span>
                      </li>
                    ))}
                  </ul>
        ...
        <section id="faq" className="py-20 md:py-32 bg-[var(--color-secondary-dark)] text-[var(--color-primary-light)]">
          <div className="container mx-auto px-8 md:px-16 text-center">
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown className={`text-[var(--color-accent-blue)] transition-transform duration-200 ${openFaq === index ? 'rotate-180' : ''}`} size={28} />
                  </button>
                  <AnimatePresence>
                    {openFaq === index && (
                      <motion.div
        ...
        <section id="mentors" className="py-20 md:py-32 bg-[var(--color-primary-dark)] text-[var(--color-primary-light)]">
          <div className="container mx-auto px-8 md:px-16 text-center">
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="max-w-xs mx-auto mb-12">
              ...
              >
                <img src={president.image} alt={president.name} className="w-36 h-36 rounded-full mx-auto mb-6 object-cover border-4 border-[var(--color-accent-blue)]" />
                <h3 className="text-xl font-bold mb-1 text-[var(--color-primary-light)]">{president.name}</h3>
                <p className="text-gray-400 text-base">{president.title}</p>
                <p className="text-gray-400 text-base mb-2">{president.grade}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto mb-12">
              {firstMentorRow.map((mentor, index) => (
                <motion.div
                  ...
                  className="bg-[var(--color-secondary-dark)] rounded-2xl shadow-xl p-8 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl border border-gray-700"
                >
                  <img src={mentor.image} alt={mentor.name} className="w-36 h-36 rounded-full mx-auto mb-6 object-cover border-4 border-[var(--color-accent-blue)]" />
                  <h3 className="text-xl font-bold mb-1 text-[var(--color-primary-light)]">{mentor.name}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
              {secondMentorRow.map((mentor, index) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold mb-1 text-[var(--color-primary-light)]">{mentor.name}</h3>
                  <p className="text-gray-400 text-base">{mentor.title}</p>
                  <p className="text-400 text-base mb-2">{mentor.grade}</p>
                  <p className="text-gray-500 text-sm">{mentor.bio}</p>
                </motion.div>
              ))}
            </div>
      ...
      <footer className="bg-[var(--color-secondary-dark)] text-center p-8 text-gray-400">
        <div className="container mx-auto">
          <p className="text-lg mb-2">&copy; 2025 Hack Club VMSS. All rights reserved.</p>
          <p className="text-base mb-4">Made with ❤️ by Justin Li</p>
          <Link href="/contact" className="text-lg text-[var(--color-accent-blue)] hover:underline transition-colors duration-200">
            Contact Us
          </Link>
        </div>
      </footer>
