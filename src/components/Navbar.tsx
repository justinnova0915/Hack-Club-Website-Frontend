        ...
        {isLandingPage ? (
          <div className="hidden lg:flex flex-1 justify-center items-center px-4">
            <div className="flex items-center space-x-2 lg:space-x-4">
              <Link
                href="#about"
                className="text-gray-300 hover:bg-gray-700 hover:text-[var(--color-accent-blue)] px-3 py-2 rounded-md text-sm lg:text-xl xl:text-2xl font-bold transition duration-200"
              >
                About Us
              </Link>
              <Link
            ...
            {user ? (
              <>
                ...
                <Link
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline transition duration-200 text-sm"
                >
                  Dashboard
                </Link>
                <button
              ...
              <>
                ...
                <Link
                  href="/signup"
                  className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline transition duration-200 text-sm"
                >
                  Sign Up
                </Link>
              </>
              ...
              {isLandingPage ? (
                <>
                  <Link
                    ...
                    className="block text-gray-300 hover:bg-gray-700 hover:text-[var(--color-accent-blue)] px-3 py-2 rounded-md text-base font-medium"
                  >
                    About Us
                  </Link>
                  <Link
                  ...
                  {user ? (
                    <>
                      <Link
                        ...
                        onClick={() => setIsMenuOpen(false)}
                        className="block bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded-md text-base transition duration-200 mt-4 text-center"
                      >
                        Dashboard
                      </Link>
                      <button
                        ...
                        className="block w-full text-center bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-3 rounded-md text-base transition duration-200 mt-2"
                      >
                        Log Out
                      </button>
                    </>
                    ...
                    <>
                      ...
                      <Link
                        href="/signup"
                        onClick={() => setIsMenuOpen(false)}
                        className="block bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-3 rounded-md text-base transition duration-200 mt-2 text-center"
                      >
                        Sign Up
                      </Link>
                    </>
