  ...
  const Navbar = () => (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--color-primary-dark)] bg-opacity-70 backdrop-filter backdrop-blur-lg shadow-lg">
      ...
      <div className="container mx-auto px-8 py-5 flex justify-between items-center">
        <Link
          href="/"
          className="text-3xl font-bold text-[var(--color-accent-blue)]"
        >
          Hack Club VMSS
        </Link>
        {!isDesktop && (
        ...
        {isDesktop && (
          <div className="flex space-x-8 items-center">
            <Link
              href="#about"
              className="text-xl text-gray-300 hover:text-[var(--color-accent-blue)] transition-colors duration-200"
            >
              About Us
            </Link>
            <Link
              href="#what-you'll-learn"
              className="text-xl text-gray-300 hover:text-[var(--color-accent-blue)] transition-colors duration-200"
            >
              What You'll Learn
            </Link>
            ...
            <Link
              href="/login"
              className="bg-[var(--color-accent-blue)] hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-xl text-xl transition duration-200 shadow-lg hover:shadow-xl"
            >
              Log In
            </Link>
          </div>
