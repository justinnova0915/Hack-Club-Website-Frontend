                          ...
                          <ul className="pl-4 mt-1 space-y-1">
                            {lesson.software && (
                              <li>
                                <button
                                  onClick={() =>
                                    scrollToSection(lesson.software!.id)
                                  }
                            ...
                            {lesson.hardware && (
                              <li>
                                <button
                                  onClick={() =>
                                    scrollToSection(lesson.hardware!.id)
                                  }
                                  className={`w-full text-left p-2 rounded-lg transition duration-150 text-gray-400 text-sm
                            ...
                            {lesson.unified && (
                              <li>
                                <button
                                  onClick={() =>
                                    scrollToSection(lesson.unified!.id)
                                  }
                                  className={`w-full text-left p-2 rounded-lg transition duration-150 text-gray-400 text-sm
        ...
        <div className="w-full max-w-7xl">
          ...
          <div className="bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
            <p className="text-lg text-gray-300 mb-6">
              Our comprehensive curriculum is designed to guide you through
              various aspects of technology, from full-stack web development to
              AI and robotics.
            </p>
            ...
            {curriculumData.map((unit) => (
              <section
                ...
                id={unit.id}
                ref={(el) => {
                  sectionRefs.current.set(unit.id, el);
                }}
              ...
              >
                ...
                {unit.lessons.map((lesson) => (
                  <div
                    ...
                    id={lesson.id}
                    ref={(el) => {
                      sectionRefs.current.set(lesson.id, el);
                    }}
                    ...
                    <div className="space-y-6">
                      {lesson.software && (
                        <div
                          ...
                          ref={(el) => {
                            sectionRefs.current.set(lesson.software!.id, el);
                          }}
                        ...
                        >
                          <h4 className="text-xl font-medium text-[var(--color-accent-green)] mb-2">
                            {lesson.software.title}
                          </h4>
                          <p className="text-gray-300 text-base mb-2">
                            {lesson.software.summary}
                          </p>
                          <p className="text-gray-400 text-sm">
                            <span className="font-bold">Type:</span>{" "}
                            {lesson.software.type} |{" "}
                            <span className="font-bold">Instructor:</span>{" "}
                            {lesson.software.instructor}
                          </p>
                        </div>
                      )}
                      {lesson.hardware && (
                        <div
                          ...
                          ref={(el) => {
                            sectionRefs.current.set(lesson.hardware!.id, el);
                          }}
                          className={`bg-gray-700 p-4 rounded-lg shadow-inner transition-all duration-300
                        ...
                        >
                          ...
                          <p className="text-gray-300 text-base mb-2">
                            {lesson.hardware.summary}
                          </p>
                          <p className="text-gray-400 text-sm">
                            <span className="font-bold">Type:</span>{" "}
                            {lesson.hardware.type} |{" "}
                            <span className="font-bold">Instructor:</span>{" "}
                            {lesson.hardware.instructor}
                          </p>
                        </div>
                      )}
                      {lesson.unified && (
                        <div
                          ...
                          ref={(el) => {
                            sectionRefs.current.set(lesson.unified!.id, el);
                          }}
                          className={`bg-gray-700 p-4 rounded-lg shadow-inner transition-all duration-300
                        ...
                        >
                          ...
                          <p className="text-gray-300 text-base mb-2">
                            {lesson.unified.summary}
                          </p>
                          <p className="text-gray-400 text-sm">
                            <span className="font-bold">Type:</span>{" "}
                            {lesson.unified.type} |{" "}
                            <span className="font-bold">Instructor:</span>{" "}
                            {lesson.unified.instructor}
                          </p>
                        </div>
                      )}
                    </div>
            ...
            <section
              id="competition"
              ref={(el) => {
                sectionRefs.current.set("competition", el);
              }}
              className={`mb-10 pt-4 transition-all duration-300
            ...
            >
              ...
              <ul className="list-disc list-inside text-lg text-gray-300 space-y-2">
                ...
                <li>
                  <span className="font-bold">Judging:</span> Based on criteria
                </li>
              </ul>
            </section>
          </div>
