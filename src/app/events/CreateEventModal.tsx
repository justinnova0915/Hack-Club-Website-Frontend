      ...
      <div className="bg-[var(--color-primary-dark)] p-8 rounded-lg shadow-xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label
              htmlFor="title"
              className="block text-sm font-medium text-[var(--color-text-general)]"
            >
              Event Title
            </label>
            <input
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button
              type="submit"
              className="bg-[var(--color-accent-green)] hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg"
            >
              Submit
            </button>
          </div>
